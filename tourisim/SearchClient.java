...
public class SearchClient extends javax.swing.JFrame {
    ...
    public SearchClient() {
        ...
        jTable1.getTableHeader().setDefaultRenderer(new SearchClient.HeaderColor());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       Query qregisetr=emp.createNamedQuery("RegisterClients.findAll");
        ...
        for(Clients client:clientlist)
        {
            ...
            if(jTextFieldID.getText().equals(pass))
            {
           ...
           {
                String choosecar="NO";   String chooseoffer="NO";   String choosehotel="NO";   String price="";
               Clients c=rc.getPassportId();
           String regpass=c.getPassportId().toString();
           if(regpass.equals(pass))
           {
               ClientType ct=rc.getClientsType();
               if(ct.getClientsType().equals("nt"))
               {
                 for(TakeCar car:carlist)
       {
           Clients cl=car.getPassportId();
           String carpass=cl.getPassportId().toString();
           if(carpass.equals(pass))
           {
               choosecar="YES";
               break;
           }//end if
           ...
           for(BookingRoom room:hotellist)
       {
           Clients cl=room.getPassportId();
           String roompass=cl.getPassportId().toString();
           if(roompass.equals(pass))
           {
               ...
               else if(ct.getClientsType().equals("wt")){
                   chooseoffer="Yes";
               }//end else if
               
                price=rc.getTotalPrice().toString();
               String table[]={chooseoffer,choosecar,choosehotel,price};
             jTable1.setModel(dtm);
             String header[] = new String[] { "Offer", "Car", "Hotel","Total Price" };    
             dtm.setColumnIdentifiers(header);
             dtm.insertRow(0, new Object[] { table[0],table[1],table[2],table[3]});
           }//end if
           }//end reg
       ...
       for(Person person:perlist)
       {
         if(person.getPersonalId().compareTo(p.getPersonalId())==0)  
         {
             ...
             jTextFieldFN.setText(fn);
             jTextFieldLN.setText(ln);
             break;  
         }//end if
        ...
        {
             Logger.getLogger(SearchClient.class.getName()).log(Level.SEVERE, null, e);
        }
