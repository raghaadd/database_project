...
import static tourisim.Loading_Admin.jLabel2;
import static tourisim.Loading_Admin.jProgressBar1;

/**
 *
 * @author Msys
 */
public class Loading_Employee extends javax.swing.JFrame implements Runnable{

    /**
     * Creates new form Loading_Employee
     */
    Thread t;
    public Loading_Employee() {
        initComponents();
        super.pack();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Loading_Employee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Loading_Employee().setVisible(true);
            }
        });
    }
